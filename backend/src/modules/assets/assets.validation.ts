...
export const createAssetSchema = z.object({
  ...
  hostname: str(),
  macAddress: str(),
  operatingSystem: z.union([z.enum(ASSET_OPERATING_SYSTEMS), z.literal("")]).optional().default(""),
  osVersion: str(),
  CPU: str(),
  ram: str(),
  storage: str(),
  ...
  domainName: str(),
  antivirusStatus: z.enum(ASSET_ANTIVIRUS_STATUSES).optional(),
  remarks: str(),
