...
const MERGE_INTO_DESCRIPTION_FIELDS: { field: keyof MappedFields; label: string }[] = [
  ...
  { field: "operatingSystemLicense", label: "OS license (imported)" },
  { field: "canvaLicense", label: "Canva license (imported)" },
  { field: "emailLicense", label: "Email license (imported)" },
  { field: "microsoftOffice", label: "Microsoft Office (imported)" },
  { field: "microsoftProject", label: "Microsoft Project (imported)" },
  { field: "powerBi", label: "Power BI (imported)" },
  { field: "autoCad", label: "AutoCAD (imported)" },
  { field: "zwCad", label: "ZWCAD (imported)" },
  { field: "photoshop", label: "Photoshop (imported)" },
  { field: "creativeCloudPro", label: "Creative Cloud Pro (imported)" },
  { field: "illustrator", label: "Illustrator (imported)" },
  { field: "acrobatPro", label: "Acrobat Pro (imported)" },
  { field: "sketchUpPro", label: "SketchUp Pro (imported)" },
  { field: "rocketReachPro", label: "RocketReach Pro (imported)" },
  { field: "d5Render", label: "D5 Render (imported)" },
  { field: "zoomLicense", label: "Zoom license (imported)" },
  { field: "sharedFolderAccess", label: "Shared folder access (imported)" },
];
