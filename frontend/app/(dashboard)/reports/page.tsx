...
export default function ReportsPage() {
  ...
  const canViewAssets = can(user, "reports", "read") && can(user, "assets", "read")
  const canViewLicenses = can(user, "reports", "read") && can(user, "licenses", "read")
  ...
  function handleExport(format: "csv" | "excel" | "pdf") {
    ...
    window.open(`${base}${path}?format=${format}`, "_blank")
  }
