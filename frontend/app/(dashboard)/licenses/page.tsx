  ...
  const columns: ColumnDef<License, unknown>[] = [
    {
      ...
      header: "License ID",
      cell: ({ row }) => (
        <Link href={`/licenses/${row.original._id}`} className="font-medium text-primary hover:underline">
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        ...
        {canCreate && <Button render={<Link href="/licenses/add" />}>Add License</Button>}
      </div>
