...
import {
  HelpdeskPriorityFormDialog,
  type HelpdeskPriority,
} from "@/components/helpdesk-priorities/helpdesk-priority-form-dialog"
...
export default function HelpdeskPrioritiesPage() {
  ...
  const [editing, setEditing] = React.useState<HelpdeskPriority | null>(null)
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        {canWrite && <HelpdeskPriorityFormDialog onSaved={load} />}
      </div>
