...
export default function AddUserPage() {
  ...
  // Id of the saved Role template currently applied, or NO_ROLE - "Custom" (edit manually). Sent
  // to the backend (as `roleId`) if and only if it's still a real id - see
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">They&apos;ll be required to change this password the first time they log in.</p>
      </div>
      <Card>
        <CardHeader>
